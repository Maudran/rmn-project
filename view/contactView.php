...
<div id="form-wrapper">
	...
	<form id="contact-form" method="POST" action="/rmn-project/contact.htm" name="contacForm">
		...
		<div>
			...
			<div class="div-input"><input type="text" name="contact[surname]" class="contact-input" placeholder="Nom" maxlength="50" > *
				<?php if (isset($errors) && isset($errors['surname']) ): ?>
				<span class="error"><?php echo $errors['surname'] ?></span>
			<?php endif; ?>	
			</div><br>

			<div class="div-input"><input type="text" name="contact[firstname]" id="firstname" class="contact-input" placeholder="Prénom" maxlength="50" > *
			...
			<div class="div-input"><input type="email" name="contact[email]" class="contact-input" placeholder="Adresse mail" maxlength="50" > *
			...
			<div class="div-input"><textarea name="contact[message]" class="contact-input" placeholder="Votre message" rows="10" cols="50" ></textarea> *
...
$(function() {
    validForm = $("#contact-form").validate({
        ...
        messages: {
            'contact[firstname]': "Veuillez renseigner votre prénom",
            'contact[surname]': "Veuillez renseigner votre nom",
            'contact[email]': {
                required: "Veuillez renseigner votre adresse mail",
                email: "Veuillez renseigner une adresse mail valide"
            },
            'contact[message]': "Veuillez écrire votre message"
        }
    });
});
